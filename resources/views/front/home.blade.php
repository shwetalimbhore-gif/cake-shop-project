        ...
        <div class="row align-items-center min-vh-90">
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="hero-image-wrapper">
                    <img src="storage\about\homepage.png"
                         alt="Artisanal cake"
...
<section class="categories-section py-5">
    <div class="container">
        ...
        <div class="row g-4">
            @forelse($categories as $category)
            <div class="col-lg-3 col-md-4 col-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 50 }}">
                <a href="{{ route('shop', ['category' => $category->id]) }}" class="category-link">
                    <div class="category-card">
                        <div class="category-image-container">
                            @if($category->image)
                                <img src="{{ asset('storage/' . $category->image) }}"
...
.hero-section {
    background: linear-gradient(135deg, #fdf8f2 0%, #f7e6e0 100%);
    padding: 60px 0;
    min-height: auto; /* Changed from min-height to auto */
}
...
.btn-primary:hover {
    ...
    box-shadow: 0 5px 15px rgba(201, 124, 93, 0.3);
}
...
/* ===== HERO IMAGE - REDUCED VERTICAL SIZE ===== */
.hero-image-wrapper {
    text-align: center;
    padding: 0;
    margin: 0;
...
.hero-image {
    max-width: 100%;
    height: auto;
    max-height: 350px; /* Reduced from full height */
    width: auto;
    border-radius: 20px;
