                ...
                <form method="GET" action="{{ route('admin.reports.daily-sales') }}" class="d-flex gap-2">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.reports.export.daily-sales', ['format' => 'excel', 'date' => $date]) }}">
                                    <i class="fas fa-file-excel me-2 text-success"></i>Export as Excel
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.reports.export.daily-sales', ['format' => 'pdf', 'date' => $date]) }}">
