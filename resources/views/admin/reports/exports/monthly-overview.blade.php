...
<head>
    ...
    <style>
        ...
        th { background-color: #27ae60; color: white; padding: 10px; border: 1px solid #229954; }
...
<body>
    ...
    @if(!empty($pdfData))
        ...
        <div class="summary">
            ...
            <p><strong>Total Custom Cakes:</strong> {{ $totalCustom }}</p>
            <p><strong>Average Monthly Revenue:</strong> ${{ number_format($totalRevenue / count($pdfData), 2) }}</p>
        </div>
