        ...
        <form method="GET" action="{{ route('admin.reports.walkin') }}" class="row g-3">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.reports.export.walkin-vs-online', ['format' => 'excel', 'start_date' => $startDate, 'end_date' => $endDate]) }}">
                            <i class="fas fa-file-excel me-2 text-success"></i>Export as Excel
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.reports.export.walkin-vs-online', ['format' => 'pdf', 'start_date' => $startDate, 'end_date' => $endDate]) }}">
